...
class InicioFragment : Fragment() {
    ...
    val movAdapter = MovimientoAdapter(listaMov)
    ...
    override fun onCreateView(
        ...
        val balanceText = view.findViewById<TextView>(R.id.balance_total)
        BaseDeDatos.getTotal {
            balanceText.text = it.toString()
        }
        val recyclerView = view.findViewById<RecyclerView>(R.id.rv_mov)

        recyclerView.layoutManager = LinearLayoutManager(this.context)
        recyclerView.adapter = movAdapter
